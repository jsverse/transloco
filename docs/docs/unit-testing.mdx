...
type TestOptions = Omit<TranslocoTestingOptions, 'langs' | 'translocoConfig'>
export function getTranslocoModule(config: Partial<TranslocoConfig> = {}, options: TestOptions = {}) {
