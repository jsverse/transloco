...
import {provideTranslocoScopes} from "./transloco.providers";
@NgModule({
  declarations: [CoreComponent],
  providers: [provideTranslocoScopes('core')],
...
@NgModule({
  declarations: [CoreComponent],
  providers: [provideTranslocoScopes('core', { scope: 'shared', alias: 'sharedAlias' })],
  imports: [TranslocoModule]
})
export class CoreModule {}
```
