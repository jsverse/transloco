...
This way you can leverage Angular's DI power and make your translations even more flexible.
...
In this case, we are checking if the user has `newDashboard` flag, in case he does, we want to display  
