...
{% tab title="pnpm" %}
```bash
pnpm add @jsverse/transloco-persist-translations@next
```
{% endtab %}

{% tab title="yarn" %}
```bash
yarn add @jsverse/transloco-persist-translations@next
```
{% endtab %}

{% tab title="npm" %}
```bash
npm install @jsverse/transloco-persist-translations@next
```
{% endtab %}
{% endtabs %}
