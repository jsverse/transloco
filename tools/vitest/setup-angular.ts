...
// Shared Angular test setup for every jsdom project. Loads zone.js (+ testing
// plugins) and patches Vitest's describe/it/beforeEach to run inside a
// ProxyZone — required for TestBed and fakeAsync/tick.
