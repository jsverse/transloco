import {apply, EmptyTree, move, source, Tree} from "@angular-devkit/schematics";
...
export function createTranslateFiles(langs: string[], creator: (source: Tree, lang: string) => void, path) {
