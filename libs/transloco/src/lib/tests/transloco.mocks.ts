...
import en from '../../../../../apps/playground/src/assets/i18n/en.json';
import es from '../../../../../apps/playground/src/assets/i18n/es.json';
import enLazy from '../../../../../apps/playground/src/assets/i18n/lazy-page/en.json';
import esLazy from '../../../../../apps/playground/src/assets/i18n/lazy-page/es.json';
import enAdmin from '../../../../../apps/playground/src/assets/i18n/admin-page/en.json';
import esAdmin from '../../../../../apps/playground/src/assets/i18n/admin-page/es.json';
import enLazyScopeAlias from '../../../../../apps/playground/src/assets/i18n/lazy-scope-alias/en.json';
import esLazyScopeAlias from '../../../../../apps/playground/src/assets/i18n/lazy-scope-alias/es.json';
import enMF from '../../../../../apps/playground/src/assets/i18n/transpilers/messageformat/en.json';
import esMF from '../../../../../apps/playground/src/assets/i18n/transpilers/messageformat/es.json';
