...
The repo uses pnpm; its version is pinned in `package.json`'s `packageManager` field, and any other pnpm version switches to it automatically. Start by installing all dependencies:
